              ...
              <div className="bg-white rounded-2xl p-8 ring-1 ring-[#d2d2d7]/40 shadow-sm">
                ...
                <div className={`mb-6 rounded-2xl bg-gradient-to-br p-6 text-white ${
                  ...
                  <p className="text-[15px] text-white/60 mt-1">
                    {profile?.account_type === "business"
                      ? isRTL
                        ? "مجاني للأعمال يشمل أول 100 ضمان مُصدر مع الاحتفاظ بالسجلات. الاحترافية مخططة بسعر 15 ر.س / 4 دولارات شهريًا."
                        : "Business Free includes the first 100 issued warranties with records retained. Professional is planned at SAR 15 / USD 4 per month."
                      : isRTL

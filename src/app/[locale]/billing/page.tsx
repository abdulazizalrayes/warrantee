                    ...
                    <div className="mt-4 mb-5">
                      {plan.price === 0 ? (
                        ...
                        <div>
                          ...
                          <span className="text-[14px] text-[#86868b]"> /{isRTL ? "سنة" : "year"}</span>
                          {plan.id === "pro" && (
                            <p className="text-[12px] text-[#30d158] font-medium mt-1">{isRTL ? "السنة الأولى مجانية!" : "First year free!"}</p>
                          )}
                        </div>
                      )}
                    </div>

...
export default function SupportPage() {
  ...
  const channels = [
    { icon: Mail, title: isRTL ? tr("Ø§ÙØ¨Ø±ÙØ¯ Ø§ÙØ¥ÙÙØªØ±ÙÙÙ") : "Email", desc: "support@warrantee.io", sub: isRTL ? tr("Ø±Ø¯ Ø®ÙØ§Ù 24 Ø³Ø§Ø¹Ø©") : "Response within 24 hours", color: "#007aff" },
    { icon: MessageCircle, title: isRTL ? tr("Ø§ÙØ¯Ø±Ø¯Ø´Ø© Ø§ÙÙØ¨Ø§Ø´Ø±Ø©") : "Live Chat", desc: isRTL ? tr("ØªØ­Ø¯Ø« ÙØ¹ ÙØ±ÙÙÙØ§") : "Chat with our team", sub: isRTL ? tr("ÙØªØ§Ø­ 9Øµ-6Ù") : "Available 9AM-6PM", color: "#30d158" },
    { icon: Clock, title: isRTL ? tr("ÙØ±ÙØ² Ø§ÙÙØ³Ø§Ø¹Ø¯Ø©") : "Help Center", desc: isRTL ? tr("ÙÙØ§ÙØ§Øª ÙØ£Ø¯ÙØ©") : "Articles and guides", sub: isRTL ? tr("ÙØªØ§Ø­ 24/7") : "Available 24/7", color: "#ff9f0a" },
  ];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-[28px] font-semibold text-[#1d1d1f] tracking-tight">
            {isRTL ? tr("Ø§ÙØ¯Ø¹Ù") : "Support"}
          </h1>
          <p className="text-[15px] text-[#86868b] mt-2">
            {isRTL ? tr("ÙØ­Ù ÙÙØ§ ÙÙØ³Ø§Ø¹Ø¯ØªÙ") : "We\'re here to help"}
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl ring-1 ring-[#d2d2d7]/40 shadow-sm overflow-hidden mb-10">
          <div className="px-6 py-4 border-b border-[#d2d2d7]/30">
            <h2 className="text-[17px] font-semibold text-[#1d1d1f]">
              {isRTL ? tr("Ø£Ø±Ø³Ù Ø±Ø³Ø§ÙØ©") : "Send a Message"}
            </h2>
          </div>
          {sent ? (
            <div className="p-10 text-center">
              ...
              <h3 className="text-[17px] font-semibold text-[#1d1d1f] mb-2">
                {isRTL ? tr("ØªÙ Ø§ÙØ¥Ø±Ø³Ø§Ù!") : "Message Sent!"}
              </h3>
              <p className="text-[14px] text-[#86868b]">
                {isRTL ? tr("Ø³ÙØ±Ø¯ Ø¹ÙÙÙ Ø®ÙØ§Ù 24 Ø³Ø§Ø¹Ø©") : "We\'ll get back to you within 24 hours"}
              </p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-[13px] font-medium text-[#1d1d1f] mb-1.5">{isRTL ? tr("Ø§ÙØ§Ø³Ù") : "Name"}</label>
                  <input
                    type="text"
                    value={name}
                    ...
                    placeholder={isRTL ? tr("Ø§Ø³ÙÙ") : "Your name"}
                  />
                </div>
                <div>
                  <label className="block text-[13px] font-medium text-[#1d1d1f] mb-1.5">{isRTL ? tr("Ø§ÙØ¨Ø±ÙØ¯") : "Email"}</label>
                  <input
                    type="email"
                    value={email}
                    ...
                    required
                    className="w-full px-4 py-2.5 rounded-xl bg-[#f5f5f7] border-0 ring-1 ring-[#d2d2d7]/40 text-[14px] text-[#1d1d1f] placeholder:text-[#86868b] focus:ring-2 focus:ring-[#007aff] outline-none transition-all"
                    placeholder={isRTL ? tr("Ø¨Ø±ÙØ¯Ù") : "Your email"}
                  />
                </div>
              </div>
              <div>
                <label className="block text-[13px] font-medium text-[#1d1d1f] mb-1.5">{isRTL ? tr("Ø§ÙÙÙØ¶ÙØ¹") : "Subject"}</label>
                <input
                  type="text"
                  value={subject}
                  ...
                  required
                  className="w-full px-4 py-2.5 rounded-xl bg-[#f5f5f7] border-0 ring-1 ring-[#d2d2d7]/40 text-[14px] text-[#1d1d1f] placeholder:text-[#86868b] focus:ring-2 focus:ring-[#007aff] outline-none transition-all"
                  placeholder={isRTL ? tr("ÙÙØ¶ÙØ¹ Ø§ÙØ±Ø³Ø§ÙØ©") : "What is this about?"}
                />
              </div>
              <div>
                <label className="block text-[13px] font-medium text-[#1d1d1f] mb-1.5">{isRTL ? tr("Ø§ÙØ±Ø³Ø§ÙØ©") : "Message"}</label>
                <textarea
                  value={message}
                  ...
                  placeholder={isRTL ? tr("ÙÙÙ ÙÙÙÙÙØ§ ÙØ³Ø§Ø¹Ø¯ØªÙØ") : "How can we help you?"}
                />
              </div>
              <button
                type="submit"
              ...
              >
                ...
                {submitting ? (isRTL ? "\u062c\u0627\u0631\u064a \u0627\u0644\u0625\u0631\u0633\u0627\u0644..." : "Sending...") : (isRTL ? tr("Ø¥Ø±Ø³Ø§Ù") : "Send Message")}
              </button>
            </form>
          )}
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <Link href={"/" + locale + "/guide"} className="bg-white rounded-2xl p-5 ring-1 ring-[#d2d2d7]/40 shadow-sm hover:shadow-md transition-all flex items-center gap-4 group">
            ...
            <div className="flex-1">
              <div className="text-[14px] font-medium text-[#1d1d1f]">{isRTL ? tr("Ø¯ÙÙÙ Ø§ÙØ§Ø³ØªØ®Ø¯Ø§Ù") : "Getting Started Guide"}</div>
              <div className="text-[12px] text-[#86868b]">{isRTL ? tr("ØªØ¹ÙÙ Ø§ÙØ£Ø³Ø§Ø³ÙØ§Øª") : "Learn the basics"}</div>
            </div>
          ...
          <Link href={"/" + locale + "/warranties"} className="bg-white rounded-2xl p-5 ring-1 ring-[#d2d2d7]/40 shadow-sm hover:shadow-md transition-all flex items-center gap-4 group">
            ...
            <div className="flex-1">
              <div className="text-[14px] font-medium text-[#1d1d1f]">{isRTL ? tr("Ø¶ÙØ§ÙØ§ØªÙ") : "My Warranties"}</div>
              <div className="text-[12px] text-[#86868b]">{isRTL ? tr("Ø¥Ø¯Ø§Ø±Ø© Ø§ÙØ¶ÙØ§ÙØ§Øª") : "Manage warranties"}</div>
            </div>

...
export default function SellerRegisterPage() {
  ...
  const t = locale === 'ar' ? {
    ...
    launchSteps: ['\u062a\u0642\u062f\u064a\u0645 \u0628\u064a\u0627\u0646\u0627\u062a \u0627\u0644\u0628\u0627\u0626\u0639', '\u0625\u0635\u062f\u0627\u0631 \u0623\u0648\u0644 \u0636\u0645\u0627\u0646', '\u0645\u0634\u0627\u0631\u0643\u0629 QR \u0648\u0627\u0644\u0634\u0647\u0627\u062f\u0629', 'ربط API / CLI / MCP عند الحاجة'],
    ...
    launchSteps: ['Submit seller details', 'Issue first warranty', 'Share QR and certificate', 'Connect API / CLI / MCP when ready'],
    step1: 'Company Info',

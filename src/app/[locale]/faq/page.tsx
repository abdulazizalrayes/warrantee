...
const faqs = {
  en: [
    ...
    },
    {
      ...
      a: "Personal Free includes up to 10 personal warranties. Business Free includes the first 100 issued customer warranties. The planned Professional launch price is SAR 14.90/month in the GCC or USD 3.99/month elsewhere and currently requires access confirmation. Enterprise pricing is custom by agreement."
    },
    {
  ...
  ar: [
    ...
    },
    {
      ...
      a: "تشمل الخطة المجانية للأفراد حتى 10 ضمانات شخصية، وتشمل المجانية للأعمال أول 100 ضمان مُصدر للعملاء. سعر الإطلاق المخطط للاحترافية هو 14.90 ريالًا شهريًا في دول الخليج أو 3.99 دولار شهريًا خارجها، ويتطلب التفعيل حاليًا تأكيدًا من Warrantee. أسعار المؤسسات مخصصة حسب الاتفاق."
    },
    {

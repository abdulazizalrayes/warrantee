...
export const RESOURCE_PAGES: SeoContentPage[] = [
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer: {
          en: "Personal Free includes up to 10 personal warranties. Business Free includes the first 100 issued customer warranties. The planned Professional launch price is SAR 14.90 / USD 3.99 per month, but it is not charged automatically while paid checkout remains inactive. Enterprise scope and pricing are agreed directly.",
          ar: "تشمل الخطة المجانية للأفراد حتى 10 ضمانات شخصية، وتشمل الخطة المجانية للأعمال أول 100 ضمان مُصدر للعملاء. سعر الإطلاق المخطط للخطة الاحترافية هو 14.90 ريالًا / 3.99 دولار شهريًا، ولا يتم الخصم تلقائيًا ما دام الدفع الإلكتروني غير مفعّل. يتم الاتفاق مباشرة على نطاق وسعر خطة المؤسسات.",
        },
      },
    ],
    cta: {

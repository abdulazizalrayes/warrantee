...
const dictionaries: Record<IndexedLocale, Dictionary> = {
  en: {
    ...
    pricing: {
      ...
      subtitle: "Start with Free. Request Professional access when you need more capacity and workflow depth.",
      plans: [
        {
          id: "free",
          name: "Free",
        ...
        },
        {
          ...
          name: "Professional",
          price: "SAR 149",
          description: "Planned Saudi-first launch price. Request access before activation.",
          features: [
  ...
  ar: {
    ...
    pricing: {
      ...
      subtitle: "ابدأ بالخطة المجانية، واطلب الوصول إلى الخطة الاحترافية عندما تحتاج إلى سعة أكبر ومسارات عمل أعمق.",
      plans: [
        {
          id: "free",
          name: "\u0645\u062c\u0627\u0646\u064a",
        ...
        },
        {
          ...
          name: "\u0627\u062d\u062a\u0631\u0627\u0641\u064a",
          price: "149 \u0631.\u0633",
          description: "سعر إطلاق سعودي مخطط. اطلب التفعيل قبل الاشتراك.",
          features: [
            "\u0636\u0645\u0627\u0646\u0627\u062a \u063a\u064a\u0631 \u0645\u062d\u062f\u0648\u062f\u0629",

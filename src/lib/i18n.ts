  ...
  en: {
    ...
    features: {
      ...
      items: [
        ...
        { id: "bilingual_certs", title: "Bilingual Certificates", description: "Generate professional warranty certificates in Arabic and English with QR verification." },
        { id: "dashboard", title: "Warranty Dashboard", description: "View current warranty status, expiration dates, and claim history in one central hub." },
        { id: "email_to_warranty", title: "Email-to-Warranty", description: "Forward supported emails to prepare warranty records while keeping attachments connected." },
    ...
    how_it_works: {
      ...
      steps: [
        ...
        { id: "approve", title: "Approve & Track", description: "Route to approvers, record decisions, and activate warranties." },
        { id: "track", title: "Monitor & Claim", description: "Track current status and process claims with supporting documentation." },
      ],
    },
    pricing: {
      title: "Simple, Transparent Pricing",
      subtitle: "Choose Personal for your own purchases or Business to issue customer warranties. Upgrade only when your business needs more capacity.",
      plans: [
        {
          id: "personal-free",
          name: "Personal Free",
          price: "SAR 0",
          description: "For protecting your own purchases",
          features: [
        ...
        },
        {
          ...
          name: "Business Free",
          price: "SAR 0",
          description: "For issuing warranties to customers",
          features: [
            "First 100 issued warranties",
            "Customer certificates and QR passports",
  ...
  ar: {
    ...
    features: {
      ...
      items: [
        ...
        { id: "bilingual_certs", title: "شهادات ثنائية اللغة", description: "أنشئ شهادات ضمان احترافية بالعربية والإنجليزية مع التحقق عبر QR." },
        { id: "dashboard", title: "لوحة الضمانات", description: "اعرض حالة الضمان الحالية وتواريخ الانتهاء وسجل المطالبات في مركز واحد." },
        { id: "email_to_warranty", title: "البريد الإلكتروني للضمان", description: "أعد توجيه رسائل البريد المدعومة لتحضير سجلات الضمان مع إبقاء المرفقات مرتبطة." },
    ...
    how_it_works: {
      ...
      steps: [
        ...
        { id: "approve", title: "الموافقة والتتبع", description: "وجّه الضمانات للموافقين وسجّل القرارات وفعّل الضمانات." },
        { id: "track", title: "المراقبة والمطالبة", description: "تتبّع الحالة الحالية وعالج المطالبات مع المستندات الداعمة." },
      ],
    },
    pricing: {
      title: "\u0623\u0633\u0639\u0627\u0631 \u0628\u0633\u064a\u0637\u0629 \u0648\u0634\u0641\u0627\u0641\u0629",
      subtitle: "اختر الحساب الشخصي لمشترياتك أو حساب الأعمال لإصدار ضمانات العملاء، ثم رقّ حساب الأعمال فقط عندما تحتاج إلى سعة أكبر.",
      plans: [
        {
          id: "personal-free",
          name: "مجاني للأفراد",
          price: "0 ر.س",
          description: "لحفظ ضمانات مشترياتك الشخصية",
          features: [
            "حتى 10 ضمانات شخصية",
          ...
          cta: "أنشئ حسابًا شخصيًا",
        },
        {
          id: "business-free",
          name: "مجاني للأعمال",
          price: "0 ر.س",
          description: "لإصدار ضمانات للعملاء",
          features: [
            "أول 100 ضمان مُصدر",
            "شهادات العملاء وجوازات المنتج عبر QR",
            "مسار مطالبات أساسي",
            "مستخدم أعمال واحد",
            "الاحتفاظ بسجل الضمان كاملًا",
          ],
          cta: "أنشئ حساب أعمال",
        },
        {
    ...
    auth: { login: "\u062a\u0633\u062c\u064a\u0644 \u0627\u0644\u062f\u062e\u0648\u0644", signup: "\u0625\u0646\u0634\u0627\u0621 \u062d\u0633\u0627\u0628", magic_link: "\u0625\u0631\u0633\u0627\u0644 \u0631\u0627\u0628\u0637 \u0633\u062d\u0631\u064a", google: "\u0627\u0644\u0645\u062a\u0627\u0628\u0639\u0629 \u0645\u0639 Google", apple: "\u0627\u0644\u0645\u062a\u0627\u0628\u0639\u0629 \u0645\u0639 Apple", password: "\u0643\u0644\u0645\u0629 \u0627\u0644\u0645\u0631\u0648\u0631", email: "\u0639\u0646\u0648\u0627\u0646 \u0627\u0644\u0628\u0631\u064a\u062f \u0627\u0644\u0625\u0644\u0643\u062a\u0631\u0648\u0646\u064a", remember_me: "\u062a\u0630\u0643\u0631\u0646\u064a", forgot_password: "\u0647\u0644 \u0646\u0633\u064a\u062a \u0643\u0644\u0645\u0629 \u0627\u0644\u0645\u0631\u0648\u0631\u061f", sign_in: "\u062a\u0633\u062c\u064a\u0644 \u0627\u0644\u062f\u062e\u0648\u0644", create_account: "\u0625\u0646\u0634\u0627\u0621 \u062d\u0633\u0627\u0628", no_account: "\u0644\u064a\u0633 \u0644\u062f\u064a\u0643 \u062d\u0633\u0627\u0628\u061f", have_account: "\u0647\u0644 \u0644\u062f\u064a\u0643 \u062d\u0633\u0627\u0628 \u0628\u0627\u0644\u0641\u0639\u0644\u061f" },
    dashboard: { welcome: "\u0623\u0647\u0644\u0627 \u0628\u0639\u0648\u062f\u062a\u0643", active_warranties: "\u0627\u0644\u0636\u0645\u0627\u0646\u0627\u062a \u0627\u0644\u0646\u0634\u0637\u0629", expiring_soon: "\u062a\u0646\u062a\u0647\u064a \u0642\u0631\u064a\u0628\u0627\u064b", pending_approval: "\u0641\u064a \u0627\u0646\u062a\u0638\u0627\u0631 \u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0629", recent_activity: "\u0627\u0644\u0646\u0634\u0627\u0637 \u0627\u0644\u0623\u062e\u064a\u0631", view_all: "\u0639\u0631\u0636 \u0627\u0644\u0643\u0644", create_new: "\u0625\u0646\u0634\u0627\u0621 \u062c\u062f\u064a\u062f", total_managed: "\u0625\u062c\u0645\u0627\u0644\u064a \u0627\u0644\u0636\u0645\u0627\u0646\u0627\u062a \u0627\u0644\u0645\u064f\u062f\u0627\u0631\u0629", this_month: "\u0647\u0630\u0627 \u0627\u0644\u0634\u0647\u0631" },
    warranty: { create: "\u0625\u0646\u0634\u0627\u0621 \u0636\u0645\u0627\u0646", status: { draft: "\u0645\u0633\u0648\u062f\u0629", pending: "\u0641\u064a \u0627\u0646\u062a\u0638\u0627\u0631 \u0627\u0644\u0645\u0648\u0627\u0641\u0642\u0629", active: "\u0646\u0634\u0637", claimed: "\u062a\u0645 \u0627\u0644\u0627\u062f\u0639\u0627\u0621", expired: "\u0627\u0646\u062a\u0647\u062a \u0635\u0644\u0627\u062d\u064a\u062a\u0647", cancelled: "\u062a\u0645 \u0627\u0644\u0625\u0644\u063a\u0627\u0621" }, fields: { product_name: "\u0627\u0633\u0645 \u0627\u0644\u0645\u0646\u062a\u062c", serial_number: "\u0631\u0642\u0645 \u0633\u0644\u0633\u0644\u0629", purchase_date: "\u062a\u0627\u0631\u064a\u062e \u0627\u0644\u0634\u0631\u0627\u0621", warranty_end_date: "\u062a\u0627\u0631\u064a\u062e \u0627\u0646\u062a\u0647\u0627\u0621 \u0627\u0644\u0636\u0645\u0627\u0646", coverage_type: "\u0646\u0648\u0639 \u0627\u0644\u062a\u063a\u0637\u064a\u0629", coverage_amount: "\u0645\u0628\u0644\u063a \u0627\u0644\u062a\u063a\u0637\u064a\u0629", covered_items: "\u0627\u0644\u0639\u0646\u0627\u0635\u0631 \u0627\u0644\u0645\u063a\u0637\u0627\u0629", terms_conditions: "\u0627\u0644\u0634\u0631\u0648\u0637 \u0648\u0627\u0644\u0623\u062d\u0643\u0627\u0645", start_date: "\u062a\u0627\u0631\u064a\u062e \u0627\u0644\u0628\u062f\u0627\u064a\u0629", customer_name: "\u0627\u0633\u0645 \u0627\u0644\u0639\u0645\u064a\u0644", customer_email: "\u0628\u0631\u064a\u062f \u0627\u0644\u0639\u0645\u064a\u0644 \u0627\u0644\u0625\u0644\u0643\u062a\u0631\u0648\u0646\u064a" }, actions: { approve: "\u0645\u0648\u0627\u0641\u0642\u0629", reject: "\u0631\u0641\u0636", claim: "\u0627\u0644\u0627\u062d\u0639\u0627\u0621 \u0628\u0627\u0644\u0636\u0645\u0627\u0646", extend: "\u062a\u0645\u062d\u064a\u062d \u0627\u0644\u0636\u0645\u0627\u0646", cancel: "\u0625\u0644\u063a\u0627\u0621", download: "\u062a\u062d\u0645\u064a\u0644", share: "\u0645\u0634\u0627\u0631\u0643\u0629", edit: "\u062a\u0639\u062f\u064a\u0644", delete: "\u062d\u0630\u0641" } },
    common: { loading: "\u062c\u0627\u0631\u064a \u0627\u0644\u062a\u062d\u0645\u064a\u0644...", error: "\u062e\u0637\u0623", success: "\u0646\u062c\u062d", cancel: "\u0625\u0644\u063a\u0627\u0621", save: "\u062d\u0641\u0638", delete: "\u062d\u0630\u0641", edit: "\u062a\u0639\u062f\u064a\u0644", back: "\u0639\u0648\u062f\u0629", next: "\u0627\u0644\u062a\u0627\u0644\u064a", previous: "\u0627\u0644\u0633\u0627\u0628\u0642", more_info: "\u0645\u0639\u0644\u0648\u0645\u0627\u062c \u0623\u0643\u062b\u0631", help: "\u0645\u0633\u0627\u0639\u062f\u0629", settings: "\u0627\u0644\u0625\u0639\u062f\u0627\u062d\u0627\u062a", logout: "\u062a\u0633\u062c\u064a\u0644 \u0627\u0644\u062e\u0631\u0648\u062c", language: "\u0627\u0644\u0644\u063a\u0629", english: "English", arabic: "\u0627\u0644\u0639\u0631\u0628\u064a\u0629", retry: "إعادة المحاولة", all: "الكل" },
    claims: { title: "المطالبات", new_claim: "مطالبة جديدة", status: "الحالة", warranty: "الضمان", description: "الوصف", date: "التاريخ", no_claims: "لا توجد مطالبات", submit: "تقديم مطالبة", evidence: "الأدلة", statuses: { pending: "قيد الانتظار", approved: "موافق", rejected: "مرفوض", in_review: "قيد المراجعة" } },
    billing: { title: "الفواتير", current_plan: "الخطة الحالية", upgrade: "ترقية الخطة", manage: "إدارة الاشتراك", invoices: "الفواتير", invoice_date: "التاريخ", amount: "المبلغ", status: "الحالة", download: "تحميل", free_plan: "مجاني", pro_plan: "احترافي", enterprise_plan: "مؤسسات", per_month: "/شهر", usage: "الاستخدام", warranties_used: "الضمانات المستخدمة" },
  },
};
